...
- Physical-device review on a Xiaomi Redmi Note 14 Pro using Chrome (version not recorded): left and right featured-slider swipes failed. Vertical scrolling, normal hero-link taps, post-swipe link suppression, arrows, thumbnails, both article CTAs, and mobile layout/overflow passed. PR remains not ready for review until the swipe failure is resolved and retested.
