...
### 2026-08-05 - Imperial Airways archival-enquiry package

- Prepared, but did not send, institution-specific requests for the *Scipio* accident file, Imperial Airways timetables and maps, staff records, and *Imperia* vessel evidence. The package records only official contact routes and does not presume that any institution holds the report.
- The National Archives is the first route for the unidentified accident file; British Airways Heritage is the first company-record route. RAeS, RAF Museum and AAIB are limited referral/collection checks; the CAA is not an initial accident-record target under its published remit.
- Corrected the eventual article-length record: there is no 2,500-word maximum. Do not draft until the publication gate is met and the user explicitly authorises article production.
