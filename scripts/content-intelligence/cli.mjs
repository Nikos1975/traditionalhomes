...
export async function runContentCli({ command, argv, rootDir = process.cwd(), generatedRootDir = rootDir, authProvider = new LocalUserAdcAuthProvider(), transport = new SearchConsoleTransport() }) {
