...
| Deployment, Cloudflare account, DNS and edge redirect administration | `.agents/workspaces/operations-deployment/CONTEXT.md`; an SEO finding is not an authorization to deploy or to change Cloudflare |
